...
// Interfaces
import { IRelayAnchorStateRegistry } from "../interfaces/IRelayAnchorStateRegistry.sol";
import { IDisputeGame } from "optimism/src/dispute/AnchorStateRegistry.sol";
import { IZKVerifier } from "../interfaces/IZKVerifier.sol";

contract MockZKDisputeGame is Clone {
    ////////////////////////////////////////////////////////////////
    //                         Structs                            //
    ////////////////////////////////////////////////////////////////
    ...
    /// @notice The verifier.
    IZKVerifier immutable public verifier;

    /// @notice The finalization delay.
    uint256 immutable public finalizationDelay;
    ...
    constructor(ZKConstructorParams memory _params) {
        ...
        finalizationDelay = _params.finalizationDelay;
    }
    ...
    function resolve(bytes calldata _proof) external returns (GameStatus status_) {
